...
`IF_${e}`,((t,s)=>{const _=s.querySelector(`#${e}_script`);_&&(_.src=_.dataset.src)}))},listener__v:()=>{for(let e of["burst","aster","paint"]){const t=document.getElementById(`LA_${e}`);t&&t.addEventListener("click",(()=>STAT_o.adopt__v(e)),{once:!0})}},init__v://!!! 1. from index.js
