...
class WorkerClient{constructor(s){Object.assign(this,s),this.port_o=new SharedWorker(this.url_s).port,this.port_o.onerror=s=>console.log`ERROR: ${s.message}`,this.port_o.onmessage=s=>this.message__v(s.data)}message__v(s){s.client_s&&s.client_s!==this.client_s||this.handleMessage__v(s)}post__v(s){this.port_o.postMessage(s)}}const STAT_o={worker_o:null,get_scan_a:["burst","aster","paint"],canvas__e(s,t){const e=2048*window.devicePixelRatio,_=document.querySelector(`#canvas_${s}_${t}`);return _.width=e,_.height=e,_},message__v(s){s.task_s},putCanvas__v(s,t,e,_){for(let a of _){const _=STAT_o.canvas__e(s,a).transferControlToOffscreen();e.port_o.postMessage({task_s:"PUT_canvas",stat_s:s,part_s:a,script_s:t,pixel_n:window.devicePixelRatio,canvas_e:_},[_])}},worker__o(s,t,e){const _=new WorkerClient({url_s:"/assets/scripts/js/stat_w.min.js",stat_s:s,handleMessage__v:e});switch(s){case"burst":STAT_o.putCanvas__v(s,t,_,["hue","sat","lum"]);break;case"aster":case"paint":STAT_o.putCanvas__v(s,t,_,["initial","processed"])}return _},adopt__v(s){document.getElementById(`IF_${s}`)&&IND_o.adopt__v(s,//!!! section id=stat_s
