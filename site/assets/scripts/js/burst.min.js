...
const BUR_o =
{
  ...
  )
  {
    const center_n =
      document
        .getElementById( `canvas_burst_hue` )    //: all canvases (hue, sat, lum) have same size
          .width
      *
      .5      //: width / 2
      *
  ...
  ()
  {
      ...
      .trace_o =
        {
          hue_e:
            document
              .getElementById( `burst_hue_n` ),
          hueRatio_e:
            document
              .getElementById( `burst_hue_ratio_n` ),
          sat_e:
            document
              .getElementById( `burst_sat_n` ),
          satRatio_e:
            document
              .getElementById( `burst_sat_ratio_n` ),
          lum_e:
            document
              .getElementById( `burst_lum_n` ),
          lumRatio_e:
            document
              .getElementById( `burst_lum_ratio_n` ),
        }
    ...
    )
    {
      ...
      {
        document
          .getElementById( `canvas_burst_${part_s}` )
            ?.addEventListener
            (
              event_s,
              traceHandler__v
    ...
    {
      document
        .getElementById( `burst_scale_${scale_s}` )
          ?.addEventListener
          (
            'click',
            (
