...
const AST_o =
{
  ...
  )
  {
    const center_n =
      document
        .getElementById( `canvas_aster_hue` )    //: all canvases (hue, sat, lum) have same size
          .width
      *
      .5      //: width / 2
      *
  ...
  ()
  {
      ...
      .trace_o =
        {
          hue_e:
            document
              .getElementById( `aster_hue_n` ),
          hueRatio_e:
            document
              .getElementById( `aster_hue_ratio_n` ),
          sat_e:
            document
              .getElementById( `aster_sat_n` ),
          satRatio_e:
            document
              .getElementById( `aster_sat_ratio_n` ),
          lum_e:
            document
              .getElementById( `aster_lum_n` ),
          lumRatio_e:
            document
              .getElementById( `aster_lum_ratio_n` ),
        }
    */
    ...
    */
    ...
    )
    {
      ...
      {
        document
          .getElementById( `canvas_aster_${part_s}` )
            ?.addEventListener
            (
              event_s,
              traceHandler__v
    ...
    */
    ...
    {
      document
        .getElementById( `aster_scale_${scale_s}` )
          ?.addEventListener
          (
            'click',
            (
