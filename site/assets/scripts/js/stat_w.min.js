...
//!!!!!!!!!!!!!!!!!!!!!!!!!!
const o=`/assets/media/img/${_.work_s}/full/max/0/color.jpeg`,a=await fetch(o),T=await a.blob(),s=await createImageBitmap(T),t=new OffscreenCanvas(s.width,s.height).getContext("2d");t.drawImage(s,0,0);const n=t.getImageData(0,0,s.width,s.height);STAT_W_o.capacity_n=s.width*s.height,STAT_W_o.scan_a=new Array(1+STAT_W_o.SCAN_LUM_RANK_n);let A,e,S,c=360;for(STAT_W_o.scan_a[STAT_W_o.SCAN_HUE_n]=new Array(c),STAT_W_o.scan_a[STAT_W_o.SCAN_HUE_FREQ_n]=new Array(c);--c>=0;)STAT_W_o.scan_a[STAT_W_o.SCAN_HUE_n][c]=[],STAT_W_o.scan_a[STAT_W_o.SCAN_HUE_FREQ_n][c]=0;for(c=101,STAT_W_o.scan_a[STAT_W_o.SCAN_SAT_n]=new Array(c),STAT_W_o.scan_a[STAT_W_o.SCAN_SAT_FREQ_n]=new Array(c);--c>=0;)STAT_W_o.scan_a[STAT_W_o.SCAN_SAT_n][c]=[],STAT_W_o.scan_a[STAT_W_o.SCAN_SAT_FREQ_n][c]=0;for(c=101,STAT_W_o.scan_a[STAT_W_o.SCAN_LUM_n]=new Array(c),STAT_W_o.scan_a[STAT_W_o.SCAN_LUM_FREQ_n]=new Array(c);--c>=0;)STAT_W_o.scan_a[STAT_W_o.SCAN_LUM_n][c]=[],STAT_W_o.scan_a[STAT_W_o.SCAN_LUM_FREQ_n][c]=0;for(let _=0;_<n.data.length;_+=4){A=n.data[_],e=n.data[_+1],S=n.data[_+2];let o=RGB_H__n(A,e,S);STAT_W_o.scan_a[STAT_W_o.SCAN_HUE_n][o].push(_),STAT_W_o.scan_a[STAT_W_o.SCAN_HUE_FREQ_n][o]+=1;let a=~~(100*RGB_S__n(A,e,S));STAT_W_o.scan_a[STAT_W_o.SCAN_SAT_n][a].push(_),STAT_W_o.scan_a[STAT_W_o.SCAN_SAT_FREQ_n][a]+=1;let T=~~(100*RGB_L__n(A,e,S));STAT_W_o.scan_a[STAT_W_o.SCAN_LUM_n][T].push(_),STAT_W_o.scan_a[STAT_W_o.SCAN_LUM_FREQ_n][T]+=1}const r=_=>{const o=_.length;let a=new Array(o);for(let T=0;T<o;++T)a[T]=[_[T],T];return a.sort(((_,o)=>o[0]-_[0])),a};STAT_W_o.scan_a[STAT_W_o.SCAN_HUE_RANK_n]=r(STAT_W_o.scan_a[STAT_W_o.SCAN_HUE_FREQ_n]),STAT_W_o.scan_a[STAT_W_o.SCAN_SAT_RANK_n]=r(STAT_W_o.scan_a[STAT_W_o.SCAN_SAT_FREQ_n]),STAT_W_o.scan_a[STAT_W_o.SCAN_LUM_RANK_n]=r(STAT_W_o.scan_a[STAT_W_o.SCAN_LUM_FREQ_n]),console.timeEnd("scan")}},get_frequency__v(_){const{part_s:o,frequency_n:a}=_,T=o.toUpperCase();let s=STAT_W_o[`SCAN_${T}_FREQ_n`];STAT_W_o.post__v({task_s:"PUT_frequency",part_s:o,frequency_n:STAT_W_o.scan_a[s][a],capacity_n:STAT_W_o.capacity_n})},put_canvas__v(_){const{stat_s:o,part_s:a}=_;STAT_W_o.stat_o[`${o}_o`]||(STAT_W_o.stat_o[`${o}_o`]={}),STAT_W_o.stat_o[`${o}_o`][`${a}_o`]={},STAT_W_o.stat_o[`${o}_o`][`${a}_o`].canvas_o=_.canvas_e;const T=_.canvas_e.getContext("2d");STAT_W_o.pixel_n=_.pixel_n,STAT_W_o.stat_o[`${o}_o`][`${a}_o`].context_o=T},put_draw__v(_){const{stat_s:o,part_s:a}=_;let T;switch(a){case"hue":T=360;break;case"sat":case"lum":T=101}const s=a.toUpperCase(),t=`SCAN_${s}_FREQ_n`,n=`SCAN_${s}_RANK_n`,A=[];let e=0;for(let o of STAT_W_o.scan_a[STAT_W_o[t]]){let T,s,t;switch(a){case"hue":T=e,s=100,t=50;break;case"sat":T=_.hue_n,s=e,t=50;break;case"lum":T=_.hue_n,s=0,t=e}A[e]=o?{frequency_n:o,hsl_a:[T,s,t]}:null,++e}const S={color_a:A,range_n:T,canvas_o:STAT_W_o.stat_o[`${o}_o`][`${a}_o`].canvas_o,median_n:.5*STAT_W_o.stat_o[`${o}_o`][`${a}_o`].canvas_o.width,maxfreq_n:STAT_W_o.scan_a[STAT_W_o[n]][0][0]};STAT_W_o.stat_o[`${o}_o`][`${a}_o`].burst_c=new ColorBurst(S)},put_scale__v(_){const{stat_s:o,part_s:a,scale_n:T}=_;STAT_W_o.stat_o[`${o}_o`][`${a}_o`].burst_c.clear__v(),//!!! before scaling
